...
var TweetsService = (function () {
    ...
    TweetsService.prototype.getTweets = function (track_Id) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        return this.http.get('http://ec2-35-167-19-138.us-west-2.compute.amazonaws.com:8080/tweets/' + track_Id, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    TweetsService.prototype.getCount = function (track_Id) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        return this.http.get('http://ec2-35-167-19-138.us-west-2.compute.amazonaws.com:8080/tweets/' + track_Id + '/count', { headers: headers })
            .map(function (res) { return res.json(); });
    };
...
module.exports = "<div class=\"row\">\n  <div class=\"col-md-4\">\n    <div class=\"thumbnail\">\n      <img src=\"../../../images/NolaweeAbout.jpg\" alt=\"\" width=\"250\" height=\"250\">\n      <div class=\"caption\">\n        <h3>Nolawee</h3>\n        <p>Nolawee worked on front end and helped develop the web page and the data visualization as well as investigating the Spotify API. Nolawee appreciates technology and music. He's funny 0% of the time, but\n          we laugh at his jokes anyway.</p>\n      </div>\n    </div>\n  </div>\n  <div class=\"col-md-4\">\n    <div class=\"thumbnail\">\n      <img src=\"../../../images/MitchAbout.jpg\" alt=\"\" width=\"250\" height=\"250\">\n      <div class=\"caption\">\n        <h3>Mitch</h3>\n        <p>Mitch worked on the back-end. He set up Kafka, set up the AWS environment, as well as GNIP. Mitch is a Colorado Native and will be graduating this May. He enjoys long walks on the beach and prefers to jam out to music alone in his room.</p>\n      </div>\n    </div>\n  </div>\n  <div class=\"col-md-4\">\n    <div class=\"thumbnail\">\n      <img src=\"../../../images/JenAbout.jpg\" alt=\"\" width=\"250\" height=\"250\">\n      <div class=\"caption\">\n        <h3>Jen</h3>\n        <p>Jen worked on the back-end. She used nodeJS, helped Mitch with the twitter firehose, and created the data pipeline between the front-end and back in. Jen is a Colorado Native and enjoys\n          walking her dogs at the end of a long day.</p>\n      </div>\n    </div>\n  </div>\n</div>\n<div class=\"row\">\n  <div class=\"col-md-4\">\n    <div class=\"thumbnail\">\n      <img src=\"../../../images/AycelAbout.jpg\" alt=\"\">\n      <div class=\"caption\">\n        <h3>Aycel</h3>\n        <p>Aycel worked on the front-end. She investigated the use of D3 as an overlay on a Google Map. She created a map with the use of the Google Maps API and helped with the creation of the web page. Aycel is a Colorado Native. She enjoys speending\n          her summer rooting for the Rockies.</p>\n      </div>\n    </div>\n  </div>\n</div>\n"
...
module.exports = "<div class=\"row\">\n  <div class=\"col-xs-12 text-center\">\n    <h3><b>{{songRank}}. {{songTitle}}</b></h3>\n  </div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col-xs-12 pull-center\">\n    <!-- Using angular2-google-maps to display tweet location -->\n    <sebm-google-map [latitude]=\"lat\" [longitude]=\"lng\" [zoom]=\"zoom\" [styles]=\"styles\" [disableDefaultUI]=true [zoomControl]=false (mapClick)=\"mapClicked($event)\">\n\n      <sebm-google-map-marker *ngFor=\"let m of markers; let i = index\" (markerClick)=\"clickedMarker(m, index)\" [latitude]=\"m.lat\" [iconUrl]=\"'../../../images/fire.png'\" [longitude]=\"m.lng\" [markerDraggable]=false>\n      </sebm-google-map-marker>\n    </sebm-google-map>\n    <!-- Using angular2-google-maps to display tweet location -->\n  </div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col-sm-12 text-center\">\n    <h3><b>{{counter}} TWEETS</b></h3>\n  </div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col-sm-3 pull-left\">\n    <div id=\"myWidget\" class=\"SPWidget\"></div>\n  </div>\n  <div class=\"col-sm-3 pull-right\">\n\n     <div class=\"results\">\n          <div *ngIf=\"counter <= 500\">\n              <img src=\"../../../images/cryingjordan.jpg\" alt=\"\">\n          </div>\n          <div *ngIf=\"counter > 500 && counter < 1000\">\n              <iframe src=\"//giphy.com/embed/T2NINhwlHgOSk\" width=\"360\" height=\"202.5000000051\" frameBorder=\"0\" class=\"giphy-embed\" allowFullScreen></iframe>\n          </div>\n          <div *ngIf=\"counter > 1000 && counter < 2000\">\n              <iframe src=\"//giphy.com/embed/uDwKGxTFrADvO\" width=\"360\" height=\"349.8305084833\" frameBorder=\"0\" class=\"giphy-embed\" allowFullScreen></iframe>\n          </div>\n          <div *ngIf=\"counter > 2000 && counter < 3000\">\n              <iframe src=\"//giphy.com/embed/9JZuIE5vGKbGo\" width=\"360\" height=\"202.5000000051\" frameBorder=\"0\" class=\"giphy-embed\" allowFullScreen></iframe>\n          </div>\n          <div *ngIf=\"counter > 3000 && counter < 4000\">\n              <iframe src=\"//giphy.com/embed/l4xq0Cs4oJwvQGDQY\" width=\"360\" height=\"202.5000000051\" frameBorder=\"0\" class=\"giphy-embed\" allowFullScreen></iframe>\n          </div>\n          <div *ngIf=\"counter > 4000 && counter < 5000\">\n              <iframe src=\"//giphy.com/embed/YA6dmVW0gfIw8\" width=\"360\" height=\"180\" frameBorder=\"0\" class=\"giphy-embed\" allowFullScreen></iframe>\n          </div>\n          <div *ngIf=\"counter > 5000 && counter < 10000\">\n              <iframe src=\"//giphy.com/embed/l46CfciRSJKVpUvAs\" width=\"360\" height=\"180\" frameBorder=\"0\" class=\"giphy-embed\" allowFullScreen></iframe>\n          </div>\n          <div *ngIf=\"counter >= 10000\">\n              <iframe src=\"//giphy.com/embed/3o6ozkchQhWRbWSTXa\" width=\"360\" height=\"360\" frameBorder=\"0\" class=\"giphy-embed\" allowFullScreen></iframe>\n          </div>\n      </div>\n  </div>\n</div>\n"
